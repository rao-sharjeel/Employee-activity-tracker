...
__all__ = [
    'ZoomUnit_LargeDecrement', 'SynchronizedInputType_KeyUp',
    'RowOrColumnMajor', 'AnnotationType_FormatChange',
    'HeadingLevel7', 'UIA_TextEditPatternId',
    'UIA_IndentationTrailingAttributeId',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'UIA_IsActiveAttributeId', 'UIA_SliderControlTypeId',
    'TreeTraversalOptions_LastToFirstOrder',
    'WindowVisualState_Maximized',
    'UIA_RangeValueLargeChangePropertyId', 'StyleId_BulletedList',
    'UIA_HostedFragmentRootsInvalidatedEventId',
    'UIA_IndentationLeadingAttributeId', 'UIA_IsEnabledPropertyId',
    'RowOrColumnMajor_RowMajor', 'UIA_TableColumnHeadersPropertyId',
    'IRawElementProviderSimple', 'UIA_HasKeyboardFocusPropertyId',
    'UIA_TabControlTypeId', 'StructureChangeType_ChildrenReordered',
    'IUIAutomationElement6', 'AnnotationType_UnsyncedChange',
    'UIA_InputReachedOtherElementEventId', 'UIA_ToolTipOpenedEventId',
    'UIA_LegacyIAccessiblePatternId', 'IUIAutomationDockPattern',
    'OrientationType_Vertical', 'UIA_StylesStyleIdPropertyId',
    'StyleId_Custom', 'PropertyConditionFlags_MatchSubstring',
    ...
    'HeadingLevel8', 'AnnotationType_TrackChanges',
    'UIA_ThumbControlTypeId', 'DockPosition_Left',
    'IUIAutomationSelectionPattern', 'NotificationKind_Other',
    'AutomationElementMode_Full', 'UIA_OutlineStylesAttributeId',
    'UIA_Selection_InvalidatedEventId', 'WindowVisualState_Minimized',
    'ProviderOptions_HasNativeIAccessible', 'HeadingLevel5',
    'CoalesceEventsOptions_Enabled', 'UIA_RangeValueValuePropertyId',
    'UIA_StatusBarControlTypeId',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'TreeTraversalOptions', 'UIA_IsContentElementPropertyId',
    'UIA_ScrollPatternId',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'IUIAutomationChangesEventHandler', 'UIA_GridPatternId',
    ...
    'PropertyConditionFlags_None', 'UIA_ListItemControlTypeId',
    'UIA_MarginTopAttributeId', 'AutomationElementMode_None',
    'UIA_LandmarkTypePropertyId', 'UIA_Window_WindowOpenedEventId',
    'UIA_ChangesEventId', 'UIA_RangeValueMinimumPropertyId',
    'IUIAutomationVirtualizedItemPattern', 'HeadingLevel9',
    'UIA_IsTableItemPatternAvailablePropertyId',
    'IUIAutomationElement9', 'UIA_SizePropertyId',
    'UIA_FlowsToPropertyId', 'TextPatternRangeEndpoint_End',
    'IUIAutomation6', 'UIA_AnnotationTargetPropertyId',
    'IUIAutomation4', 'IUIAutomationTransformPattern',
    'UIA_AsyncContentLoadedEventId', 'UIA_SummaryChangeId',
    'UIA_MarginBottomAttributeId', 'CUIAutomation8',
    'UIA_GridColumnCountPropertyId', 'SynchronizedInputType_KeyDown',
    'IUIAutomation3', 'AnnotationType_Author',
    'UIA_IsTablePatternAvailablePropertyId', 'CUIAutomation',
    'UIA_SelectionPattern2Id', 'UIA_MarginLeadingAttributeId',
    'NotificationKind', 'UIA_ItemTypePropertyId',
    'UIA_ControllerForPropertyId', 'StructureChangeType',
    'ExpandCollapseState_Expanded', 'UIA_LiveRegionChangedEventId',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'UIA_VirtualizedItemPatternId', 'UIA_VisualEffectsPropertyId',
    'DockPosition_None', 'UIA_Invoke_InvokedEventId',
    ...
    'NavigateDirection_FirstChild', 'UIA_CulturePropertyId',
    ...
    'UIA_AccessKeyPropertyId', 'IUIAutomationTogglePattern',
    'AnnotationType_ConflictingChange', 'AnnotationType_Unknown',
    'AnnotationType_Header', 'TreeTraversalOptions_Default',
    'UIA_FlowsFromPropertyId',
    'UIA_SelectionItem_ElementSelectedEventId',
    'UIA_HeaderControlTypeId', 'UIA_WindowCanMinimizePropertyId',
    'NotificationProcessing', 'UIA_IsGridPatternAvailablePropertyId',
    ...
    'UIA_IsInvokePatternAvailablePropertyId', 'Off',
    ...
    'IUIAutomationAnnotationPattern', 'ScrollAmount_LargeIncrement',
    'IUIAutomationTextRangeArray', 'UIA_DragDropEffectsPropertyId',
    'UIA_IsItalicAttributeId', 'UIA_StrikethroughColorAttributeId',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'UIA_DragDropEffectPropertyId', 'StyleId_Emphasis',
    'WindowInteractionState', 'UIA_ValuePatternId',
    'UIA_MainLandmarkTypeId', 'AnnotationType_AdvancedProofingIssue',
    'UIA_TextChildPatternId', 'UIA_IsDataValidForFormPropertyId',
    'UIA_ClassNamePropertyId', 'PropertyConditionFlags',
    'IUIAutomationStructureChangedEventHandler',
    'UIA_ControlTypePropertyId', 'UIA_TransformCanRotatePropertyId',
    'UIA_StyleNameAttributeId', 'UIA_LineSpacingAttributeId',
    'UIA_FullDescriptionPropertyId', 'UIA_OutlineThicknessPropertyId',
    ...
    'UIA_ValueValuePropertyId', 'UIA_RangeValueMaximumPropertyId',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'HeadingLevel1', 'ProviderOptions_RefuseNonClientSupport',
    'UIA_MenuModeEndEventId', 'UIA_ImageControlTypeId',
    'UIA_NotificationEventId', 'UIA_GridRowCountPropertyId',
    'TextUnit', 'NavigateDirection_NextSibling',
    'IUIAutomationElement8', 'IAccessible',
    'UIA_StylesFillPatternColorPropertyId', 'ExtendedProperty',
    'UIA_ScrollItemPatternId', 'UIA_Text_TextSelectionChangedEventId',
    'OrientationType_Horizontal', 'NavigateDirection_LastChild',
    'UIA_CustomControlTypeId', 'IUIAutomationObjectModelPattern',
    ...
    'UIA_SayAsInterpretAsAttributeId', 'AnnotationType_Sensitive',
    'DockPosition_Bottom', 'WindowInteractionState_Running',
    'WindowVisualState_Normal', 'NotificationKind_ActionAborted',
    'IUIAutomationTextRange3', 'UIA_ProviderDescriptionPropertyId',
    'UIA_CustomNavigationPatternId', 'UIA_LabeledByPropertyId',
    'UIA_ExpandCollapsePatternId', 'UIA_CustomLandmarkTypeId',
    'UIA_ScrollBarControlTypeId', 'UIA_RangeValuePatternId',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'UIA_CaretPositionAttributeId', 'IUIAutomationDragPattern',
    'AnnotationType_DeletionChange', 'UIA_DataGridControlTypeId',
    'StyleId_Heading2', 'UIA_TreeItemControlTypeId',
    'UIA_SpinnerControlTypeId', 'ScrollAmount_SmallDecrement',
    'UIA_WindowCanMaximizePropertyId',
    'WindowInteractionState_ReadyForUserInteraction',
    'UIA_GridItemColumnPropertyId', 'UIA_ValueIsReadOnlyPropertyId',
    'StyleId_Normal', 'UIA_HelpTextPropertyId',
    'ScrollAmount_NoAmount', 'UIA_AnnotationDateTimePropertyId',
    'UIA_IndentationFirstLineAttributeId',
    'UIA_IsTextEditPatternAvailablePropertyId', 'TextUnit_Word',
    'StructureChangeType_ChildrenBulkRemoved',
    'UIA_OptimizeForVisualContentPropertyId',
    'UIA_SelectionPatternId', 'TextPatternRangeEndpoint',
    'UIA_IsTextChildPatternAvailablePropertyId',
    'UIA_IsReadOnlyAttributeId', 'UIA_DragPatternId',
    'IUIAutomationTransformPattern2', 'UIA_MenuBarControlTypeId',
    'UIA_TextPatternId', 'UIA_TextFlowDirectionsAttributeId',
    'ScrollAmount', 'HeadingLevel2', 'UIA_AnnotationTypesPropertyId',
    'TextUnit_Page', 'IUIAutomationWindowPattern',
    'WindowInteractionState_BlockedByModalWindow',
    'UIA_StylesShapePropertyId', 'UIA_NativeWindowHandlePropertyId',
    'UIA_DropTarget_DroppedEventId', 'StyleId_Subtitle',
    'IUIAutomationGridPattern', 'UiaChangeInfo',
    'UIA_CalendarControlTypeId', 'IUIAutomationProxyFactoryEntry',
    'UIA_AutomationIdPropertyId', 'HeadingLevel4',
    'UIA_TransformPatternId', 'UIA_AutomationPropertyChangedEventId',
    'IUIAutomationGridItemPattern', 'TextEditChangeType_None',
    'RowOrColumnMajor_ColumnMajor', 'UIA_EditControlTypeId',
    'StyleId_Heading5', 'UIA_LinkAttributeId', 'DockPosition',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'UIA_Transform2ZoomMaximumPropertyId', 'NavigateDirection_Parent',
    'UIA_DropTargetDropTargetEffectsPropertyId',
    'UIA_TitleBarControlTypeId', 'ExpandCollapseState_LeafNode',
    'IUIAutomationSelectionItemPattern', 'UIA_StylesPatternId',
    'UIA_TextEdit_TextChangedEventId',
    'UIA_TransformCanMovePropertyId', 'UIA_StylesFillColorPropertyId',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'IUIAutomationRangeValuePattern', 'UIA_CenterPointPropertyId',
    'UIA_RuntimeIdPropertyId', 'UIA_Drag_DragStartEventId',
    'UIA_TreeControlTypeId', 'NotificationProcessing_ImportantAll',
    'UIA_TableRowHeadersPropertyId', 'ZoomUnit_NoAmount',
    'UIA_IsRequiredForFormPropertyId', 'UIA_DocumentControlTypeId',
    'TextEditChangeType_Composition', 'IUIAutomationCondition',
    'UIA_TableControlTypeId', 'UIA_RadioButtonControlTypeId',
    'TextEditChangeType', 'SupportedTextSelection_None',
    ...
    'UIA_ScrollVerticalViewSizePropertyId', 'IUIAutomationElement7',
    'AnnotationType_GrammarError', 'UIA_FontWeightAttributeId',
    'NotificationKind_ActionCompleted', 'IUIAutomation5',
    'AnnotationType_Endnote', 'UIA_TabsAttributeId',
    'AnnotationType_DataValidationError',
    'UIA_Selection2CurrentSelectedItemPropertyId', 'ToggleState_Off',
    'IUIAutomationElementArray', 'UIA_AnimationStyleAttributeId',
    'UIA_FrameworkIdPropertyId', 'UIA_GridItemRowSpanPropertyId',
    'UIA_ItemContainerPatternId', 'UIA_InputDiscardedEventId',
    'AnnotationType_FormulaError', 'LiveSetting',
    'ScrollAmount_SmallIncrement', 'IUIAutomationTextPattern',
    'SynchronizedInputType_LeftMouseUp', 'UIA_IsPasswordPropertyId',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'UIA_DropTarget_DragEnterEventId',
    'UIA_AnnotationObjectsAttributeId',
    'UIA_IsDockPatternAvailablePropertyId',
    'ProviderOptions_NonClientAreaProvider', 'IUIAutomation2',
    'UIA_DataItemControlTypeId', 'UIA_ListControlTypeId',
    'AnnotationType_CircularReferenceError', 'ToggleState_On',
    'UIA_ButtonControlTypeId', 'UIA_TablePatternId',
    'UIA_InvokePatternId', 'IUIAutomationDropTargetPattern',
    'UIA_OverlineStyleAttributeId', 'UIA_MultipleViewPatternId',
    'NavigateDirection', 'UIA_HyperlinkControlTypeId',
    'StyleId_NumberedList', 'UIA_AriaRolePropertyId',
    'ToggleState_Indeterminate',
    'UIA_LegacyIAccessibleSelectionPropertyId',
    'UIA_NavigationLandmarkTypeId', 'DockPosition_Right',
    'UIA_IsPeripheralPropertyId', 'UIA_ClickablePointPropertyId',
    'StyleId_Quote', 'StyleId_Heading8',
    'UIA_AfterParagraphSpacingAttributeId',
    'UIA_CaretBidiModeAttributeId',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'UIA_ItemStatusPropertyId', 'IUIAutomationScrollItemPattern',
    'ZoomUnit_SmallDecrement', 'ScrollAmount_LargeDecrement',
    'UIA_MarginTrailingAttributeId', 'IUIAutomationElement2',
    'ProviderOptions_OverrideProvider', 'UIA_SelectionItemPatternId',
    'UIA_LocalizedLandmarkTypePropertyId', 'StyleId_Heading7',
    'UIA_LegacyIAccessibleNamePropertyId', 'UIA_LevelPropertyId',
    'UIA_ActiveTextPositionChangedEventId',
    'TextEditChangeType_AutoCorrect', 'UIA_ToolBarControlTypeId',
    ...
    'UIA_IsSelectionPatternAvailablePropertyId', 'StyleId_Heading3',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'ProviderOptions_UseComThreading',
    'IUIAutomationPropertyChangedEventHandler',
    'UIA_GridItemColumnSpanPropertyId',
    'UIA_IsSpreadsheetPatternAvailablePropertyId', 'Polite',
    'UIA_IsSubscriptAttributeId', 'UIA_BackgroundColorAttributeId',
    'UIA_DropTargetPatternId', 'UIA_FillColorPropertyId',
    ...
    'UIA_SpreadsheetItemFormulaPropertyId', 'UIA_MenuClosedEventId',
    'TextEditChangeType_CompositionFinalized',
    'UIA_SearchLandmarkTypeId', 'IUIAutomationScrollPattern',
    'TreeScope_Ancestors', 'HeadingLevel3',
    'AnnotationType_MoveChange', 'DockPosition_Fill',
    'UIA_ComboBoxControlTypeId', 'CoalesceEventsOptions',
    'IUIAutomation', 'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_IsSelectionItemPatternAvailablePropertyId', 'TreeScope_None',
    'UIA_WindowIsModalPropertyId', 'IUIAutomationValuePattern',
    'UIA_TransformPattern2Id', 'UIA_TransformCanResizePropertyId',
    'UIA_InputReachedTargetEventId',
    'NotificationProcessing_ImportantMostRecent',
    'UIA_IsDialogPropertyId', 'IUIAutomationTextPattern2',
    'IUIAutomationProxyFactoryMapping', 'UIA_AnnotationPatternId',
    'UIA_IsTransformPattern2AvailablePropertyId', 'ZoomUnit',
    'UIA_IsSuperscriptAttributeId',
    'StructureChangeType_ChildrenBulkAdded',
    'UIA_Drag_DragCancelEventId', 'UIA_TabItemControlTypeId',
    'UIA_WindowPatternId', 'IUIAutomationAndCondition',
    'IUIAutomationElement5', 'UIA_RotationPropertyId',
    'UIA_UnderlineColorAttributeId',
    'StructureChangeType_ChildRemoved',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'UIA_AnnotationTypesAttributeId',
    'IUIAutomationSelectionPattern2', 'StyleId_Heading4',
    'IUIAutomationEventHandler', 'SupportedTextSelection_Multiple',
    'UIA_Text_TextChangedEventId', 'SynchronizedInputType',
    'StyleId_Heading6',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'DockPosition_Top', 'StyleId_Title',
    'UIA_AutomationFocusChangedEventId', 'UIA_SpreadsheetPatternId',
    'ToggleState', 'UIA_StylesFillPatternStylePropertyId',
    'IUIAutomationProxyFactory', 'AnnotationType_ExternalChange',
    'IUIAutomationCacheRequest',
    'UIA_IsStylesPatternAvailablePropertyId',
    'UIA_SystemAlertEventId', 'UIA_ToggleToggleStatePropertyId',
    'TreeScope_Subtree', 'TreeScope', 'UIA_MenuControlTypeId',
    'UIA_SemanticZoomControlTypeId', 'TextUnit_Paragraph',
    'UIA_Transform2ZoomMinimumPropertyId', 'ZoomUnit_LargeIncrement',
    'AnnotationType_Mathematics', 'UIA_ForegroundColorAttributeId',
    'UIA_AppBarControlTypeId', 'AnnotationType_SpellingError',
    'IUIAutomationMultipleViewPattern',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'UIA_MenuModeStartEventId', 'PropertyConditionFlags_IgnoreCase',
    'UIA_SelectionSelectionPropertyId',
    'UIA_SplitButtonControlTypeId',
    'WindowInteractionState_NotResponding', 'IUIAutomationElement',
    'UIA_MenuOpenedEventId', 'ProviderOptions',
    'IUIAutomationBoolCondition',
    'ExpandCollapseState_PartiallyExpanded',
    'UIA_OutlineColorPropertyId',
    'UIA_IsScrollPatternAvailablePropertyId',
    'IUIAutomationInvokePattern', 'ExpandCollapseState_Collapsed',
    'SupportedTextSelection', 'TreeTraversalOptions_PostOrder',
    'TextEditChangeType_AutoComplete', 'UIA_PaneControlTypeId',
    'SynchronizedInputType_LeftMouseDown',
    'UIA_Selection2LastSelectedItemPropertyId', 'TreeScope_Element',
    'OrientationType', 'IUIAutomationTextEditTextChangedEventHandler',
    'AnnotationType_Footer',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'UIA_DragIsGrabbedPropertyId', 'UIA_ProgressBarControlTypeId',
    'UIA_FillTypePropertyId', 'OrientationType_None',
    'UIA_Transform2ZoomLevelPropertyId',
    'IUIAutomationTextEditPattern',
    'ConnectionRecoveryBehaviorOptions_Disabled', 'TextUnit_Document',
    'StyleId_Heading1', 'UIA_SizeOfSetPropertyId',
    'UIA_DropTarget_DragLeaveEventId',
    'UIA_IsControlElementPropertyId',
    'UIA_SelectionActiveEndAttributeId',
    'UIA_RangeValueIsReadOnlyPropertyId', 'UIA_FontSizeAttributeId',
    'ConnectionRecoveryBehaviorOptions', 'TextUnit_Line',
    'UIA_HeadingLevelPropertyId', 'UIA_TextPattern2Id',
    'UIA_NamePropertyId', 'UIA_SeparatorControlTypeId',
    'UIA_StylesStyleNamePropertyId', 'UIA_ToolTipClosedEventId',
    'UIA_LiveSettingPropertyId',
    'NotificationProcessing_CurrentThenMostRecent',
    'IUIAutomationPropertyCondition', 'UIA_IsHiddenAttributeId',
    'UIA_SpreadsheetItemPatternId', 'UIA_PositionInSetPropertyId',
    'NotificationKind_ItemAdded', 'AnnotationType_Footnote',
    'CoalesceEventsOptions_Disabled', 'UIA_ToolTipControlTypeId',
    'UIA_IsTransformPatternAvailablePropertyId',
    'StructureChangeType_ChildAdded',
    'IUIAutomationItemContainerPattern', 'AutomationElementMode',
    'UIA_CheckBoxControlTypeId',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'UIA_IsTextPattern2AvailablePropertyId',
    'StructureChangeType_ChildrenInvalidated',
    'UIA_StrikethroughStyleAttributeId',
    'UIA_DragGrabbedItemsPropertyId', 'NotificationProcessing_All',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'IUIAutomationStylesPattern', 'UIA_CapStyleAttributeId',
    'UIA_FormLandmarkTypeId', 'UIA_TextControlTypeId',
    'ProviderOptions_ClientSideProvider', 'ExpandCollapseState',
    'IUIAutomationActiveTextPositionChangedEventHandler',
    'UIA_WindowWindowInteractionStatePropertyId', 'HeadingLevel_None',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'UIA_AcceleratorKeyPropertyId', 'UIA_ProcessIdPropertyId',
    'UIA_FontNameAttributeId', 'Assertive',
    'UIA_IsGridItemPatternAvailablePropertyId',
    'AnnotationType_Comment',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'UIA_LocalizedControlTypePropertyId', 'UIA_TableItemPatternId',
    'TextUnit_Format', 'TextUnit_Character',
    'UIA_IsTextPatternAvailablePropertyId',
    'IUIAutomationOrCondition', 'IUIAutomationTableItemPattern',
    ...
    'UIA_LegacyIAccessibleRolePropertyId', 'IUIAutomationTextRange',
    'UIA_IsOffscreenPropertyId',
    'UIA_GridItemContainingGridPropertyId',
    'UIA_OverlineColorAttributeId', 'TextPatternRangeEndpoint_Start',
    'UIA_StyleIdAttributeId', 'AnnotationType_Highlighted',
    'UIA_BulletStyleAttributeId', 'UIA_AnnotationObjectsPropertyId',
    'HeadingLevel6', 'UIA_DockPatternId', 'IUIAutomationElement3',
    'UIA_OrientationPropertyId', 'IUIAutomationNotCondition',
    'UIA_Selection2ItemCountPropertyId', 'TreeScope_Descendants',
    'UIA_ScrollHorizontalViewSizePropertyId', 'TreeScope_Children',
    'WindowVisualState', 'IUIAutomationEventHandlerGroup',
    'UIA_MultipleViewCurrentViewPropertyId'
]

_check_version('1.2.0', 1612181539.844235)
